...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        && Schema::create($this->name, function (Blueprint $table) {
            ...
            $table->char('visitor_no', 32)->nullable()->comment('家长编号'); // char比varchar省1字节开销
            ...
            $table->unique(['enterprise_id', 'department_id', 'visitor_id', 'module', 'mer_id'])->nullsNotDistinct();
